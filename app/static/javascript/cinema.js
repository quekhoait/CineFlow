            ...
            <div class="mb-6">
                ...
                <div class="space-y-2">
                    ${city.location.map(item => `
                        <button onclick="clickq()" class="w-full text-left px-4 py-2 rounded-xl bg-white border border-gray-100 hover:bg-purple-50 transition-colors shadow-sm text-sm">
                            ${item.name}
                        </button>
                    `)}
                </div>
