...
def make_shell_context():
    return dict(app=app, db=db, User=models.User, Rules=models.Rules, RoleEnum=models.RoleEnum,
                ...
                Booking=models.Booking, Ticket=models.Ticket, Payment=models.Payment, BookingPaymentStatus=models.BookingPaymentStatus, PaymentType=models.PaymentType)
